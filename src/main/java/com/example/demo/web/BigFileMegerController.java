...
import com.example.demo.dto.MediaFile;
...
public class BigFileMegerController {

	private final static Logger LOGGER = LoggerFactory.getLogger(BigFileMegerController.class);
	...
	public Boolean mergechunks(String fileMd5) throws Exception {
		...
		fileMd5 = "7f28f1fed5b69dc772d44f8ee4446764.avi";
